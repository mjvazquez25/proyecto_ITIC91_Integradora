            ...
            <div id="sliderContainer">
               <div id="mySlides">
                <div id="slide1" class="slide">  
                    <img src="img/img1.jpg" alt="Slide 1 jFlow Plus" />    
                ...
                <div id="slide2" class="slide">    
                    <img src="img/img2.jpg" alt="Slide 2 jFlow Plus" />    
                    <div class="slideContent">
                        <h3>Servicios</h3>
                        <p>de alta calidad.</p>
                     </div>    
                ...
                <div id="slide3" class="slide">    
                    <img src="img/img3.jpg" alt="Slide 3 jFlow Plus" />    
                    <div class="slideContent"><h3>Arreglos Express</h3>
                    <p>Servicios a domicilio</p></div>    
                </div>        
                <div id="slide4" class="slide">    
                    <img src="img/img4.jpg" alt="Slide 3 jFlow Plus" />    
                    <div class="slideContent">
